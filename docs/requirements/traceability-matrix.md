...
| `REQ-008` | Reproduce the environment and evidence from a clean checkout | SCOPE; ARCH; ADR-001 | Build, Compose, Flyway, CI, smoke scripts | [Application foundation verification](../testing/application-foundation-verification.md), CI run, release smoke evidence | Foundation implemented; CI pending |
